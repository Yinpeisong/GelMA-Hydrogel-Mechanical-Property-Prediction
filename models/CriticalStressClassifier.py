...
# 配置参数 
data_path = "D:/yan/Code/dataset/differentialmodulus.csv"  # CSV路径
save_model_path = "D:/yan/Code/Strain-StressClassifierOutput/bnn_model.pth"
num_epochs = 1000
batch_size = 32
learning_rate = 1e-3
dropout_rate = 0.1
...
plt.tight_layout()
plt.savefig("D:/yan/Code/Strain-StressClassifierOutput/confusion_matrix.png")
...
plt.tight_layout()
plt.savefig("D:/yan/Code/Strain-StressClassifierOutput/uncertainty_plot.png")
...
plt.legend()
plt.tight_layout()
plt.savefig("D:/yan/Code/Strain-StressClassifierOutput/loss_curve.png")
